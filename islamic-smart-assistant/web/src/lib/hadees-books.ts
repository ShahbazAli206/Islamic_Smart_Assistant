...
export const HADEES_BOOKS: HadeesBook[] = [
  ...
  },
  {
    ...
    languages: [
      { code: 'ara', label: 'Arabic',     native: 'عربي',      edition: 'ara-tirmidhi' },
      { code: 'eng', label: 'English',    native: 'English',   edition: 'eng-tirmidhi' },
      { code: 'urd', label: 'Urdu',       native: 'اردو',      edition: 'urd-tirmidhi' },
      { code: 'ben', label: 'Bengali',    native: 'বাংলা',     edition: 'ben-tirmidhi' },
      { code: 'tur', label: 'Turkish',    native: 'Türkçe',    edition: 'tur-tirmidhi' },
      { code: 'ind', label: 'Indonesian', native: 'Indonesia', edition: 'ind-tirmidhi' },
    ],
  },
  {
    id: 'nasai',
  ...
  },
  {
    ...
    languages: [
      // API uses 'nawawi' slug (not 'nawawi40') — confirmed from editions.min.json
      { code: 'ara', label: 'Arabic',   native: 'عربي',    edition: 'ara-nawawi' },
      { code: 'eng', label: 'English',  native: 'English', edition: 'eng-nawawi' },
      { code: 'ben', label: 'Bengali',  native: 'বাংলা',   edition: 'ben-nawawi' },
      { code: 'tur', label: 'Turkish',  native: 'Türkçe',  edition: 'tur-nawawi' },
      { code: 'fra', label: 'French',   native: 'Français', edition: 'fra-nawawi' },
    ],
  },
  // Bulugh al-Maram is NOT available in the fawazahmed0/hadith-api; removed to avoid broken loads.
];
